...
1. Read `docs/post-authoring/v1/SPEC.md`, the generated package schema, SDK declaration, event catalogue, diagnostic catalogue, and the target controller sources before editing a package.
...
7. Add fixtures that exercise all declared capabilities, lifecycle branches, command families, property boundaries, and known failures.
