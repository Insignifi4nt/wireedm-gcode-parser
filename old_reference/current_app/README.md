...
```bash
# Requirements: Node ^20.19.0 or >=22.13.0
npm install
...
- Testing: `npm test` runs Vitest unit tests. Place unit tests under `src/__tests__/` or component `__tests__/` folders with `*.test.js`.
