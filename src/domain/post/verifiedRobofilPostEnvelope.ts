...
export function robofilV2PostEnvelopeIsReady(machine: MachineProfile) {
  return machineProfileHasCurrentVerification(machine) && matchesRobofilV2PostEnvelope(machine);
}

export function matchesRobofilV2PostEnvelope(machine: MachineProfile) {
  return (
    machine.controller.family === 'charmilles-robofil-classic' &&
