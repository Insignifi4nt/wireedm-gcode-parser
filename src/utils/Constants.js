...
export const PATH_STYLES = {
  RAPID: {
    ...
    LINE_WIDTH: 0.5, // Thinner rapid moves
    LINE_DASH: [3, 3] // Smaller dash pattern
  },
  CUT: {
    COLOR: '#00ff00', // Green for cutting moves (G1)
    LINE_WIDTH: 0.7, // Even thinner cutting moves
    LINE_DASH: []
  },
  ARC: {
    COLOR: '#00ff00', // Green for arc moves (G2/G3)
    LINE_WIDTH: 0.7, // Even thinner arc moves
    LINE_DASH: []
  }
};
...
export const MARKERS = {
  ...
  END_POINT: {
    ...
    RADIUS: 0.5, // Even smaller end point
    LABEL: 'END',
  ...
  CLICKED_POINT: {
    ...
    RADIUS: 0.5, // Smaller clicked points
