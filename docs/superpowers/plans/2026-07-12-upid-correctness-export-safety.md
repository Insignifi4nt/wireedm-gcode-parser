...
- [ ] **Step 2: Add failing structure regressions**
...
- [ ] **Step 4: Implement the shared interpreter**
...
- [ ] **Step 5: Migrate both consumers and verify GREEN**
...
- [ ] **Step 3: Implement the root-cause fixes**
...
- [ ] **Step 4: Verify GREEN and config isolation**
...
- [ ] **Step 1: Add strict-token and finite-number RED tests**
...
- [ ] **Step 2: Add BLOCK and SPLINE provenance RED tests**
...
- [ ] **Step 3: Add units, layer, and 2D-safety RED tests**
...
- [ ] **Step 5: Implement strict pairs and entity validation**
...
- [ ] **Step 6: Implement BLOCK base-point transforms and adaptive SPLINE approximation**
...
- [ ] **Step 7: Implement unit normalization and layer filtering**
...
- [ ] **Step 8: Verify GREEN and the real fixture**
...
- [ ] **Step 1: Add exact-cluster diameter RED test**
...
- [ ] **Step 2: Add duplicate, branch, and intersection RED tests**
...
- [ ] **Step 3: Add a deterministic performance RED test**
...
- [ ] **Step 5: Implement sanitization and spatial indexing**
...
- [ ] **Step 6: Implement bounds-indexed exact intersection checks**
...
- [ ] **Step 7: Verify GREEN and benchmark output**
...
- [ ] **Step 2: Add fail-closed post RED tests**
...
- [ ] **Step 3: Add precision RED tests**
...
- [ ] **Step 6: Make posting and export fail closed**
...
- [ ] **Step 7: Thread precision through the machine profile and settings UI**
...
- [ ] **Step 1: Add blocked-export UI RED test**
...
- [ ] **Step 2: Restore Contour Workbook behaviour tests**
...
- [ ] **Step 4: Implement readiness and finish the workbook**
...
- [ ] **Step 1: Run domain and focused integration suites**
...
- [ ] **Step 3: Run Playwright against the owned server**
...
- [ ] **Step 4: Re-run real-fixture and performance checks**
...
- [ ] **Step 6: Request the final whole-branch review and address every Critical/Important finding**
